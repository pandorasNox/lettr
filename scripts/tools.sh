...
func_skopeo_cli() {
  ...
  SKOPEO_CONTAINER_IMAGE=quay.io/skopeo/stable:v1.19.0@sha256:437cf8828905ae29d5dda0a6e083793a4bf734848d8df27b7a623dc6ffb486be;
...
func_renovate() {(
  ...
  # renovate: datasource=docker
  CONTAINER_IMAGE=docker.io/renovate/renovate:41.23.2@sha256:b93b155f9bf916de8494c99a2b771a566cd986a74b0cba6fb2b26a2df2a10a2c;
