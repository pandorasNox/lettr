...
func_skopeo_cli() {
  ...
  SKOPEO_CONTAINER_IMAGE=quay.io/skopeo/stable:v1.19.0@sha256:c0c7c844a14e14df1feff6962f3b250d93bb1b71fca7def26a542e38d4d6cbb5;
...
func_golangci_lint() {(
  ...
  # renovate: datasource=docker
  GOLANGCI_LINT_CONTAINER_IMAGE=golangci/golangci-lint:v2.2.2-alpine@sha256:27ec1537dc2c6b17375d234c8fc6fcb567bc73335c092bd15f1cf0190718dbd1;
...
func_renovate() {(
  ...
  # renovate: datasource=docker
  CONTAINER_IMAGE=docker.io/renovate/renovate:41.30.3@sha256:373e9c441169f9825641d1716186c067c5a0d370be023700b9efb66ced72e46b;
