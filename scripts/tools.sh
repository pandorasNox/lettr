...
func_skopeo_cli() {
  ...
  SKOPEO_CONTAINER_IMAGE=quay.io/skopeo/stable:v1.19.0@sha256:94393ee4b590b5eee3577e3a037d641b9153a0b38c730ddeafbe13275417af60;
...
func_renovate() {(
  ...
  # renovate: datasource=docker
  CONTAINER_IMAGE=docker.io/renovate/renovate:41.18.1@sha256:0e033e3a3a9ecc1740c79a85febe61df33609889da9007aabcd747741ab6c541;
