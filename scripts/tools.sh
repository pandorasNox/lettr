...
func_skopeo_cli() {
  ...
  SKOPEO_CONTAINER_IMAGE=quay.io/skopeo/stable:v1.22.2@sha256:2c1448604a0ec21760683ca751a45efce31d0c039eab1b249ef24bafb486e949;
...
func_golangci_lint() {(
  ...
  # renovate: datasource=docker
  GOLANGCI_LINT_CONTAINER_IMAGE=golangci/golangci-lint:v2.11.4-alpine@sha256:72bcd68512b4e27540dd3a778a1b7afd45759d8145cfb3c089f1d7af53e718e9;
...
func_renovate() {(
  ...
  # renovate: datasource=docker
  CONTAINER_IMAGE=docker.io/renovate/renovate:41.173.1@sha256:e998e1218fe572e23278d8808186a310784f7cb2ac8055307183ffc51d3a59e5;
