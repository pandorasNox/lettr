...
func_skopeo_cli() {
  ...
  SKOPEO_CONTAINER_IMAGE=quay.io/skopeo/stable:v1.19.0@sha256:2cc4a0f12ad7e6e4ad1f657a08cdb9496857a2ec64e40276fa5ffda8842cce37;
...
func_renovate() {(
  ...
  # renovate: datasource=docker
  CONTAINER_IMAGE=docker.io/renovate/renovate:41.90.1@sha256:d135ceb567e332b26a14e55492946080b9c9c416932227be4e48a89f875a462d;
