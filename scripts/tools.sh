...
func_skopeo_cli() {
  ...
  SKOPEO_CONTAINER_IMAGE=quay.io/skopeo/stable:v1.19.0@sha256:4665e7a95e6908482feae30c780a5952fc96e6244977ade8f04a958ea8c9985d;
...
func_golangci_lint() {(
  ...
  # renovate: datasource=docker
  GOLANGCI_LINT_CONTAINER_IMAGE=golangci/golangci-lint:v2.3.1-alpine@sha256:f83883c085e1738e9a346c6e83006fd0606a6b3d7cbcdb3d40e4c8f1ec5e44e8;
